...
#let description = "AI/ML Engineer and Data Scientist Building Secure, Scalable, & Complex Systems"
...
== Skills
    ...
    list(
        ...
        [*Tools & Databases*: Jupyter, PySpark, Hadoop, Git, Linux, PostgreSQL, MongoDB, Jira, MS Office, ROS2, Codex, Claude Code],
    )
} else {
    list(
        [*Programming Languages*: Python, R, SQL, Java, C/C++/CUDA, JavaScript/TypeScript, Rust, Bash],
