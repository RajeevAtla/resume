...
- *AI/ML*: NumPy, PyTorch, JAX, TensorFlow, Keras, Pandas, Scikit-Learn, Transformers, LangChain/LangGraph, DSPy, RAG, Hugginface (Transformers, Tokenizers, Datasets, Diffusers)
